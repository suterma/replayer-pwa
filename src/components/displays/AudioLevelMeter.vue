...
import { ref, type PropType, computed, watchEffect, onBeforeUnmount, onMounted } from 'vue'
 ...
 */
let floatSampleBuffer: Float32Array<ArrayBuffer>
 ...
 */
let byteSampleBuffer: Uint8Array<ArrayBuffer>
...
function start() {
     ...
     */
    canUseFloatTimeDomainData = typeof analyser.getFloatTimeDomainData === 'function'
