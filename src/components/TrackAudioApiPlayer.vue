<template>
  <PlayerChrome :title="title" :loaded="hasLoadedData" :isFading="isFading" :playing="playing" @stop="stop"
    @pause="pause" @play="play" :isPlayingRequestOutstanding="isPlayingRequestOutstanding"
    v-model:currentSeconds="currentSeconds" :playbackMode="playbackMode" @update:playbackMode="updatePlaybackMode"
    :volume="volume" @update:volume="updateVolume" :muted="muted" @mute="mute" @seek="seekToSeconds"
    :durationSeconds="durationSeconds" @download="download" :sourceDescription="sourceDescription" :error="mediaError"
