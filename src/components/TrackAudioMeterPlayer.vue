...
/** A simple vue audio player, for a single track, with a waveform visualization
 * //TODO NOTE: This compontent currently has some drawbacks
 * - does seemingly not work directly with the Web Audio API, needs to have a DOM player element
 * - Posiiton gets only updated while playing (relevant, when using a referenced player)
 * - only one visualization plugin works at a time (at least for me)
...
export default defineComponent({
     ...
     */
    created() {
        console.debug(`TrackAudioMeterPlayer::created`);
     ...
     */
    unmounted() {
        console.debug(`TrackAudioMeterPlayer::unmounted`);
